...
enc_weights = Path("RTVC/saved_models/default/encoder.pt")
voc_weights = Path("RTVC/saved_models/default/vocoder.pt")
synth_dir = Path("RTVC/saved_models/default/synthesizer.pt")
